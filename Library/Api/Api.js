...
const CREATEDATABASECONNECTION='https://script.google.com/macros/s/AKfycbxHQH_kk7ovfIaHdXtsD_z2dqXQE1nwSO3W6mpYBPXhXfFpF2JOK72wV_ebsYjgpEHY9g/exec';
const CREATETABLECONNECTION='https://script.google.com/macros/s/AKfycbzhovbTYHMwWgfZUq9A3Z3akO6HEpE2OB4LKjSkWF5fx1-WUKc4dJ2MhVcgIyajEaX6qw/exec';
const COMPOSEEMAILCONNECTION='https://script.google.com/macros/s/AKfycbzadYn-_BI8doMkz1okkprjTw7wFw9S09rbhjjJhsUDBveO95r0NnX5dljHc4hfLJgDjQ/exec';
`;
const APIS=()=>{
    localStorage.setItem('APIS',LINKS);
};
export{APIS};